            ...
            <div className="page">
                ...
                <div className="section-content">
                    <div className="about-message">
                        ...
                        <p>Current I am Technical Director of <a href="http://wearediscover.com">Discover Corporation</a> where I lead the development of all our products and software solutions.</p>
